...
{	(void)type;
	...
	case SOAP_TYPE_OBD__GetSpeedResponse:
		return soap_in_OBD__GetSpeedResponse(soap, NULL, NULL, "OBD:GetSpeedResponse");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		{	*type = SOAP_TYPE_OBD__GetSpeed;
			return soap_in_OBD__GetSpeed(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "OBD:GetSpeedResponse"))
		{	*type = SOAP_TYPE_OBD__GetSpeedResponse;
			return soap_in_OBD__GetSpeedResponse(soap, NULL, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE_OBD__GetSpeedResponse:
		return soap_out_OBD__GetSpeedResponse(soap, tag, id, (const struct OBD__GetSpeedResponse *)ptr, "OBD:GetSpeedResponse");
	case SOAP_TYPE__QName:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_OBD__GetSpeed:
		...
		break;
	case SOAP_TYPE_OBD__GetSpeedResponse:
		soap_serialize_OBD__GetSpeedResponse(soap, (const struct OBD__GetSpeedResponse *)ptr);
		break;
	case SOAP_TYPE__QName:
...
{	switch (p->type)
	...
	case SOAP_TYPE_OBD__GetSpeedResponse:
		if (p->size < 0)
			...
			SOAP_DELETE_ARRAY((struct OBD__GetSpeedResponse*)p->ptr);
		break;
	case SOAP_TYPE_OBD__GetSpeed:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_OBD__GetSpeed(struct soap *soap, const struct OBD__GetSpeed *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_OBD__GetSpeed(struct soap *soap, const char *tag, int id, const struct OBD__GetSpeed *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_OBD__GetSpeed), type))
		return soap->error;
	return soap_element_end_out(soap, tag);
}

SOAP_FMAC3 struct OBD__GetSpeed * SOAP_FMAC4 soap_in_OBD__GetSpeed(struct soap *soap, const char *tag, struct OBD__GetSpeed *a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct OBD__GetSpeed *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_OBD__GetSpeed, sizeof(struct OBD__GetSpeed), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_OBD__GetSpeed(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct OBD__GetSpeed *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_OBD__GetSpeed, 0, sizeof(struct OBD__GetSpeed), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_OBD__GetSpeed(struct soap *soap, const struct OBD__GetSpeed *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_OBD__GetSpeed);
	if (soap_out_OBD__GetSpeed(soap, tag?tag:"OBD:GetSpeed", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct OBD__GetSpeed * SOAP_FMAC4 soap_get_OBD__GetSpeed(struct soap *soap, struct OBD__GetSpeed *p, const char *tag, const char *type)
{
	if ((p = soap_in_OBD__GetSpeed(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct OBD__GetSpeed * SOAP_FMAC2 soap_instantiate_OBD__GetSpeed(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_OBD__GetSpeed(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_OBD__GetSpeed, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct OBD__GetSpeed);
		if (size)
			*size = sizeof(struct OBD__GetSpeed);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct OBD__GetSpeed, n);
		if (size)
			*size = n * sizeof(struct OBD__GetSpeed);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct OBD__GetSpeed*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_OBD__GetSpeed(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct OBD__GetSpeed %p -> %p\n", q, p));
	*(struct OBD__GetSpeed*)p = *(struct OBD__GetSpeed*)q;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_default_OBD__GetSpeedResponse(struct soap *soap, struct OBD__GetSpeedResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_int(soap, &a->speed);
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_OBD__GetSpeedResponse(struct soap *soap, const struct OBD__GetSpeedResponse *a)
{
#ifndef WITH_NOIDREF
	(void)soap; (void)a; /* appease -Wall -Werror */
#endif
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_OBD__GetSpeedResponse(struct soap *soap, const char *tag, int id, const struct OBD__GetSpeedResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)type;
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_OBD__GetSpeedResponse), type))
		return soap->error;
...
SOAP_FMAC3 struct OBD__GetSpeedResponse * SOAP_FMAC4 soap_in_OBD__GetSpeedResponse(struct soap *soap, const char *tag, struct OBD__GetSpeedResponse *a, const char *type)
{
	size_t soap_flag_speed = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct OBD__GetSpeedResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_OBD__GetSpeedResponse, sizeof(struct OBD__GetSpeedResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default_OBD__GetSpeedResponse(soap, a);
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
	...
	{	a = (struct OBD__GetSpeedResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_OBD__GetSpeedResponse, 0, sizeof(struct OBD__GetSpeedResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_OBD__GetSpeedResponse(struct soap *soap, const struct OBD__GetSpeedResponse *a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_OBD__GetSpeedResponse);
	if (soap_out_OBD__GetSpeedResponse(soap, tag?tag:"OBD:GetSpeedResponse", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 struct OBD__GetSpeedResponse * SOAP_FMAC4 soap_get_OBD__GetSpeedResponse(struct soap *soap, struct OBD__GetSpeedResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in_OBD__GetSpeedResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct OBD__GetSpeedResponse * SOAP_FMAC2 soap_instantiate_OBD__GetSpeedResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_OBD__GetSpeedResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_OBD__GetSpeedResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct OBD__GetSpeedResponse);
		if (size)
			*size = sizeof(struct OBD__GetSpeedResponse);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct OBD__GetSpeedResponse, n);
		if (size)
			*size = n * sizeof(struct OBD__GetSpeedResponse);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct OBD__GetSpeedResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy_OBD__GetSpeedResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct OBD__GetSpeedResponse %p -> %p\n", q, p));
	*(struct OBD__GetSpeedResponse*)p = *(struct OBD__GetSpeedResponse*)q;
}
